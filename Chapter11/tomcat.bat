...
:startServer
echo Starting Tomcat in new window echo got here
...
:startSecure
echo got to startSecure
%_SECSTARTJAVA% %TOMCAT_OPTS% -Djavax.net.ssl.keyStore=../jakartaKeyStore -Djavax.net.ssl.keyStorePassword=jakarta -Djavax.net.ssl.trustStore=../jakartaKeyStore -Djava.security.manager -Djava.security.policy=="%TOMCAT_HOME%/conf/tomcat.policy" -Dtomcat.home="%TOMCAT_HOME%" org.apache.tomcat.startup.Tomcat %3 %4 %5 %6 %7 %8 %9
goto cleanup
