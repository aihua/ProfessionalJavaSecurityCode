...
public class CallableStatementProxy extends AbstractProxy implements CallableStatement {
	...
	private static final Class[] REGISTER_OUT_PARAMETER_1 = 
	{int.class, int.class, int.class};

	private static final Class[] REGISTER_OUT_PARAMETER_2 = 
	{int.class, int.class, java.lang.String.class};

	private static final Class[] REGISTER_OUT_PARAMETER_3 = 
	{int.class, int.class};
	...
	public void registerOutParameter(int param0, int param1, int param2) throws SQLException {
		...
		try {
			invoke( "registerOutParameter", args, REGISTER_OUT_PARAMETER_1, null );
		}catch(InvocationTargetException e){
			throw (SQLException)e.getTargetException();
		}catch(RemoteException e){
			throw new RemoteSQLException(Debug.getStackTraceAsString(e));
	...
	public void registerOutParameter(int param0, int param1, java.lang.String param2) throws SQLException {
		Object args[] = new Object[ 3 ];
		args[ 0 ] = new Integer( param0 );
		args[ 1 ] = new Integer( param1 );
		args[ 2 ] = param2;
		...
		try {
			invoke( "registerOutParameter", args, REGISTER_OUT_PARAMETER_2, null );
		}catch(InvocationTargetException e){
			throw (SQLException)e.getTargetException();
		}catch(RemoteException e){
			throw new RemoteSQLException(Debug.getStackTraceAsString(e));
	...
	public void registerOutParameter(int param0, int param1) throws SQLException {
		...
		try {
			invoke( "registerOutParameter", args, REGISTER_OUT_PARAMETER_3, null );
		}catch(InvocationTargetException e){
			throw (SQLException)e.getTargetException();
		}catch(RemoteException e){
			throw new RemoteSQLException(Debug.getStackTraceAsString(e));
